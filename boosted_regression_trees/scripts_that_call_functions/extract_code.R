...
### primary datasets used for model fitting ####
...
csv_path_fishing=glue("/Users/heatherwelch/Dropbox/IUU_GRW/fishing_activity_modeling_2017_2019/fishing_{dist}_12hr_{type}_{abs_f}_{date}.csv")
...
extracto_static_wrapper_fishing_2017_background_distinct_reviewer4(date=date2,outdir=outdir,csv_path=csv_path_fishing,vessel="all",type2="all")
mclapply(vesselNames,FUN=extracto_static_wrapper_fishing_2017_background_distinct_reviewer4,outdir=outdir,csv_path=csv_path_fishing,date=date2,type2="vessel_class",mc.cores = 6)
